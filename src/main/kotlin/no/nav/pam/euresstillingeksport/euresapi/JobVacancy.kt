...
data class PositionQualifications(
    val positionCompetency: PositionCompetency? = null,
    val educationRequirement: EducationRequirement? = null,
    val experienceSummary: ExperienceSummary? = null,
    val licenseTypeCode: LicenseTypeCode? = null,
)
...
data class ExperienceCategory(
    val categoryCode: JobCategoryCode,
    val measure: Measure,
)
